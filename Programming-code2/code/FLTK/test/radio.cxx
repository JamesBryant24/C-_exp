...
int main(int argc, char **argv) {
  ...
  { Fl_Double_Window* o = new Fl_Double_Window(369, 214);
    ...
    { Fl_Group* o = new Fl_Group(190, 10, 70, 120);
      ...
      { Fl_Round_Button* o = new Fl_Round_Button(190, 10, 70, 30, "radio");
        o->type(102);
        o->down_box(FL_ROUND_DOWN_BOX);
      } // Fl_Round_Button* o
      { Fl_Round_Button* o = new Fl_Round_Button(190, 40, 70, 30, "radio");
        o->type(102);
        o->down_box(FL_ROUND_DOWN_BOX);
      } // Fl_Round_Button* o
      { Fl_Round_Button* o = new Fl_Round_Button(190, 70, 70, 30, "radio");
        o->type(102);
        o->down_box(FL_ROUND_DOWN_BOX);
      } // Fl_Round_Button* o
      { Fl_Round_Button* o = new Fl_Round_Button(190, 100, 70, 30, "radio");
        o->type(102);
        o->down_box(FL_ROUND_DOWN_BOX);
      } // Fl_Round_Button* o
      o->end();
